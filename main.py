...
data = pd.read_csv('C:/Users/Green Events/Desktop/Singapore_flat_resale/mrt.csv')
...
with st.sidebar:
    selected = option_menu("Main Menu", ["About Project", "Predictions"],
                           ...
                           styles={"nav-link": {"font": "sans serif", "font-size": "20px", "text-align": "centre"},
                                   "nav-link-selected": {"font": "sans serif", "background-color": "#83D6FF"},
                                   "icon": {"font-size": "20px"}
                                   }
                           )
...
if selected == "About Project":
    st.markdown("# :white[Singapore Resale Flat Prices Prediction]")
    ...
    st.markdown("### :blue[App created by :] Tamiz Hari")
    

# ------------------------------------------------Predictions Section---------------------------------------------------
if selected == "Predictions":
    st.markdown("# :white[Predicting Results based on Trained Models]")
